...
const PROMPT_RESOURCES = [
  { name: '松果先森（Nana 提示词图库）', category: '常用', url: 'https://opennana.com/awesome-prompt-gallery', note: '高频可直接复用的 Nano Pro 提示词集合。', tags: ['Nano Pro', '图库'] },
  { name: 'YouMind Nano Banana Pro', category: '常用', url: 'https://youmind.com/zh-CN/nano-banana-pro-prompts', note: '偏实战风格的提示词汇总。', tags: ['Nano Banana', '实战'] },
  ...
  { name: 'TwitterHot', category: '补充资源', url: 'https://twitterhot.vercel.app/', note: '趋势与资源聚合。', tags: ['趋势'] },
